...
-->
<script>
    import SignInButton from "./GoogleSignIn.svelte";
        ...
        <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            <div>
              <span class="w-full inline-flex rounded-md shadow-sm">
                ...
                <SignInButton class="ml-4 block w-full rounded-md shadow-sm " />
                <GithubLogin
                    clientId="Client_ID"
                    scope="user:email"
                    redirectUri="https://scrapex.ai"
                    ...
                    <button
                        on:click={onLogin}
                        class="h-12 w-full flex flex-row w-full mt-4">
                        <svg
                            class="h-8 w-8 flex-grow flex-no-shrink fill-current justify-around items-center mt-2"
                            role="img"
                            viewBox="0 0 24 24"
                        ...
                        <div
                            class="flex align-center flex-grow m-3 mr-8 font-medium tracking-tight">
                            Sign in with Github
                        </div>
                    </button>
                </GithubLogin>
